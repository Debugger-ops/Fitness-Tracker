      ...
      <div className={styles.formRow}>
        <div className={styles.formGroup}>
          ...
          <input
            ...
            onChange={handleChange}
            min="1"
            className={errors.sets ? styles.inputError : ''}
          />
          {errors.sets && <span className={styles.errorMessage}>{errors.sets}</span>}
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <input
            ...
            onChange={handleChange}
            min="1"
            className={errors.reps ? styles.inputError : ''}
          />
          {errors.reps && <span className={styles.errorMessage}>{errors.reps}</span>}
        </div>
